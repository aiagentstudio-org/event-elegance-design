  ...
  head: () => ({
    meta: [
      { title: "RS Group Events | Luxury Wedding & Corporate Event Planners Delhi NCR" },
      {
        name: "description",
        content:
          "Award-winning luxury event planners in Delhi NCR. Specializing in bespoke weddings, high-end corporate galas, and elite private celebrations with architectural precision.",
      },
      {
        name: "keywords",
        content:
          "luxury wedding planner delhi, corporate event organizers delhi, event management surajkund, luxury events ncr, rs group events",
      },
      { property: "og:title", content: "RS Group Events — The Architecture of Elite Celebrations" },
      {
        property: "og:description",
        content:
          "Bespoke luxury events designed in exquisite detail across Delhi, Noida, and Gurgaon.",
      },
...
const services = [
  {
    icon: Heart,
    title: "Weddings",
    desc: "Bespoke wedding design — from intimate ceremonies to grand celebrations.",
  },
  {
    icon: Briefcase,
    title: "Corporate Events",
    desc: "Launches, conferences, dinners and brand experiences with precision.",
  },
  {
    icon: PartyPopper,
    title: "Private Celebrations",
    desc: "Birthdays, anniversaries and festive parties styled with elegance.",
  },
];
...
const testimonials = [
  {
    name: "Aanya & Rohan",
    event: "Wedding · Surajkund",
    quote:
      "RS Group turned our wedding into a dream. Every detail, from the floral mandap to the guest experience, was flawless.",
  },
  {
    name: "Karan Mehta",
    event: "Corporate Gala · Gurgaon",
    quote:
      "Professional, creative and remarkably calm under pressure. Our launch event was the talk of the industry.",
  },
  {
    name: "Priya S.",
    event: "Anniversary · Delhi",
    quote: "An evening we will never forget. The attention to detail was simply exquisite.",
  },
];
      ...
      <div ref={containerRef}>
        ...
        <section className="relative isolate overflow-hidden min-h-screen flex items-center justify-center">
          ...
          <div className="relative z-10 container-luxe text-center">
            ...
            <p className="hero-sub mt-12 max-w-2xl mx-auto text-text-muted text-xl md:text-2xl font-light">
              We design complex intersections of space, light, and emotion. The visionary creators
              of grandeur in Delhi NCR.
            </p>
            ...
            <div className="hero-cta mt-16 flex flex-wrap justify-center gap-6">
              <CtaButton
                to="/contact"
                variant="gold"
                className="px-12 py-5 text-sm uppercase tracking-widest font-bold"
              >
                Plan Your Event
              </CtaButton>
              <CtaButton
                to="/gallery"
                variant="outline"
                className="px-12 py-5 text-sm uppercase tracking-widest font-bold backdrop-blur-sm"
              >
                View Portfolio
              </CtaButton>
            </div>
            ...
            <div className="bento-grid mt-24">
              ...
              <div className="bento-card span-2 bg-bg-accent flex flex-col justify-between group overflow-hidden relative min-h-[400px]">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <p className="text-text-muted max-w-md">
                    From concept to execution, we curate weddings that are as unique as the love
                    they celebrate. Specializing in grand celebrations across Faridabad and
                    Surajkund.
                  </p>
                </div>
                ...
                <div className="h-full flex flex-col justify-between relative z-10">
                  <div className="space-y-4">
                    ...
                    <p className="text-text-muted">
                      High-stakes product launches and industry summits delivered with architectural
                      precision in Delhi NCR.
                    </p>
                  </div>
                  <div className="mt-20">
                    ...
                    <div className="text-[10px] uppercase tracking-widest text-text-muted mt-2">
                      Precision Delivery Rate
                    </div>
                    <p className="mt-6 text-sm text-text-muted/60 leading-relaxed italic">
                      "The seamless execution of joy in every boardroom."
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bento-card bg-bg-card/50 backdrop-blur-sm group overflow-hidden relative">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <p className="text-text-muted text-sm">
                    Elegant celebrations for the moments that matter most in the Surajkund region.
                  </p>
                </div>
              </div>
              ...
              <div className="bento-card bg-gold/5 border-gold/10 group overflow-hidden relative">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <p className="text-text-muted text-sm">
                    We handle the complexity of global logistics and design, starting from our base
                    in Taj Surajkund.
                  </p>
                </div>
              </div>
          ...
          <div className="container-luxe py-32 md:py-48 grid md:grid-cols-2 gap-24 items-center text-left">
            <div className="relative perspective-container">
              ...
              <div className="absolute -bottom-12 -right-12 hidden lg:block bg-bg-card text-text-main p-12 max-w-[280px] border border-gold/30 shadow-3xl z-20 rounded-2xl backdrop-blur-xl">
                ...
                <div className="text-[11px] uppercase tracking-[0.3em] mt-4 font-bold text-text-muted leading-relaxed">
                  Years of Masterful Craftsmanship
                </div>
              </div>
            </div>
            <div className="space-y-10">
              <div className="gold-divider !justify-start">
                <span className="eyebrow">The Ethos</span>
              </div>
              <h2 className="font-display text-6xl md:text-8xl text-text-main leading-[1.05]">
                Where every detail <br /> becomes a{" "}
                <span className="italic text-gold">legacy.</span>
              </h2>
              <p className="text-xl text-text-muted leading-relaxed font-light max-w-xl">
                Founded on the principles of architectural precision and artistic flair, RS Group
                Events is a boutique production studio. We don't just plan; we curate. Every
                texture, every lighting cue, and every guest interaction is designed to evoke a
                sense of wonder.
              </p>
              <div className="pt-6">
                <CtaButton to="/about" variant="navy" className="px-16 py-5 scale-110">
                  Our Story
                </CtaButton>
              </div>
            </div>
        ...
        <section className="container-luxe py-32 md:py-48 relative overflow-hidden" data-animate>
          <SectionHeading
            ...
            title="Exquisite Moments"
            subtitle="A collection of recent celebrations that define our signature aesthetic."
            light
          />
          ...
          <div className="mt-24 text-center">
            <CtaButton to="/gallery" variant="outline" className="px-20 py-6 text-lg scale-110">
            ...
            <div className="mt-20 grid md:grid-cols-3 gap-8">
              {testimonials.map((t) => (
                <div key={t.name} className="bento-card bg-white/5 border-white/5 p-12 group">
                  <Quote
                    className="text-gold opacity-10 absolute top-8 right-8 group-hover:opacity-30 transition-opacity"
                    size={48}
                  />
                  <p className="text-text-main/90 leading-relaxed italic font-display text-2xl">
                    "{t.quote}"
                  </p>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="text-gold/40 text-[9px] uppercase tracking-[0.4em] mt-2">
                      {t.event}
                    </div>
                  </div>
                </div>
        ...
        <section className="relative overflow-hidden" data-animate>
          ...
          <div className="container-luxe py-32 text-center relative z-10">
            ...
            <p className="mt-12 text-bg-main/70 text-xl md:text-2xl font-light max-w-2xl mx-auto">
              Available for exclusive bookings across Delhi NCR and destination weddings.
            </p>
            <div className="mt-16 flex flex-wrap justify-center gap-6">
              <CtaButton
                href="tel:+919953595353"
                variant="gold"
                className="!bg-white !text-bg-main px-12 py-6 text-sm uppercase tracking-[0.3em] font-bold"
              >
                Call Representative
              </CtaButton>
              <CtaButton
                to="/contact"
                variant="outline"
                className="!border-white text-white/70 !text-bg-main px-12 py-6 text-sm uppercase tracking-[0.3em] font-bold"
              >
                Send Inquiry
              </CtaButton>
            </div>
          </div>
          <div className="decorative-text bottom-0 right-0 !text-bg-main opacity-[0.05]">
            RS GROUP
          </div>
        </section>
      </div>
