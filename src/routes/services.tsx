  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Luxury Event Services in Delhi NCR" },
      {
        ...
        content: "End-to-end planning, decor and coordination — bespoke for every event.",
      },
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "For weddings, 6–12 months ahead is ideal. During peak season (November–February), we recommend 12–18 months. For corporate and private events, 4–8 weeks is comfortable.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Fees depend on event scale and services. RS Group offers modular packages — from day-of coordination to full-service planning — tailored to your budget and vision. Contact us for a bespoke quote.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Absolutely. We design with the same care for an intimate 30-guest dinner as for a 1,000-guest wedding.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Surajkund, Faridabad, South Delhi, Gurgaon, Noida, Greater Noida, Ghaziabad, and across Delhi NCR. We also manage destination weddings across India and internationally.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "A decorator focuses on visual design — florals, lighting, and staging. A planner manages the entire event lifecycle: vendor coordination, timelines, hospitality, and day-of execution. RS Group provides both under one roof.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. We offer modular packages including day-of coordination, where our team manages every vendor, timeline cue, and detail while you celebrate.",
      },
    },
  ],
};
...
const faqs = [
  ...
  },
  {
    ...
    a: "Surajkund, Faridabad, South Delhi, Gurgaon, Noida, Greater Noida, Ghaziabad, and across Delhi NCR. We also manage destination weddings across India and internationally.",
  },
  {
    ...
    <Layout>
      <div ref={containerRef}>
        <PageHero
          ...
          title={
            <span className="services-main-title !text-white !opacity-100 drop-shadow-2xl">
              Luxury event services in{" "}
              <span className="italic !text-gold !opacity-100">Delhi NCR</span>
            </span>
          }
          subtitle={
        ...
        {detail.map((d, i) => (
          ...
          >
            <div className="decorative-text -top-10 -left-10 opacity-[0.02] pointer-events-none select-none">
              {d.eyebrow.split(" ")[0].toUpperCase()}
            </div>
            <div
            ...
            <div className="relative z-10 w-full">
              <div className="container-luxe mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
                <div className="max-w-2xl">
                  <SectionHeading
                    eyebrow="The RS Methodology"
                    title="The Alchemy of an Event"
                    bgText="PROCESS"
                    light
                    align="left"
                  />
                ...
                <div className="hidden md:flex flex-col items-end gap-4 pb-4">
                  <div className="text-[10px] uppercase tracking-[0.4em] text-gold/60">
              ...
              <div className="alchemy-track flex gap-12 px-[10vw] md:px-[15vw] w-max">
                {alchemySteps.map((s) => (
                  <div
                    key={s.title}
                    className="alchemy-card group relative flex-shrink-0 w-[75vw] md:w-[50vw] lg:w-[40vw] h-[60vh] md:h-[65vh] overflow-hidden rounded-sm border border-white/10 bg-white/5 backdrop-blur-sm shadow-2xl transition-all duration-700 hover:border-gold/40"
                  >
                    <img
                      src={s.img}
                    ...
                    <div className="absolute top-12 left-12">
                      <span className="font-display text-8xl md:text-[12rem] text-white/5 group-hover:text-gold/10 transition-colors duration-1000 select-none leading-none">
                        {s.n}
                      </span>
                    </div>
                    ...
                    <div className="absolute inset-0 p-10 md:p-16 flex flex-col justify-end">
                      ...
                      <h3 className="font-display text-5xl md:text-6xl text-white mb-6 leading-tight tracking-tight">
                        {s.title}
                      </h3>
                ...
                <div className="alchemy-card flex-shrink-0 w-[80vw] md:w-[50vw] lg:w-[40vw] h-[60vh] md:h-[65vh] overflow-hidden rounded-sm border-2 border-gold/20 bg-gold/5 p-8 md:p-12 flex flex-col justify-center items-center text-center backdrop-blur-md">
                  <div className="space-y-6 mb-8">
                    ...
                    <h3 className="font-display text-4xl md:text-6xl text-white italic leading-tight">
                      Your masterpiece <br /> starts here.
                    </h3>
                  </div>
                  <CtaButton
                    to="/contact"
                    variant="gold"
                    className="px-12 py-6 !rounded-none shadow-[0_0_50px_rgba(212,175,55,0.1)]"
                  >
                    BOOK YOUR DATE
                  </CtaButton>
                </div>
        ...
        {/* FAQ + CTA */}
        <section
          className="container-luxe py-32 md:py-48 grid lg:grid-cols-2 gap-20 items-start"
          data-animate
        >
          <div className="space-y-16">
            ...
            <div className="space-y-8">
              {faqs.map((f) => (
                <details
                  key={f.q}
                  className="group glass-card border border-border/20 overflow-hidden cursor-pointer hover:border-gold/30 transition-all duration-500"
                >
            ...
            <div className="relative z-20 space-y-10">
              ...
              <div className="pt-8">
                <CtaButton
                  to="/contact"
                  variant="navy"
                  className="w-full sm:w-auto px-12 py-5 scale-110"
                >
                  Book Consultation
                </CtaButton>
              </div>
