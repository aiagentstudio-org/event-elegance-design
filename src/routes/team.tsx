...
export const Route = createFileRoute("/team")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "The visionary artisans and meticulous planners behind RS Group Events.",
      },
    ],
  }),
  component: TeamPage,
...
const philosophies = [
  {
    img: pHeart,
    title: "Heart-Led",
    desc: "We don't just plan events; we care for your memories. Every decision is filtered through the emotional heartbeat of your celebration.",
    tint: "from-rose-500/40",
  },
  {
    img: pArtistic,
    title: "Artistic Edge",
    desc: "Pushing the boundaries of conventional event decor. We architect spaces that challenge the expected and embrace the avant-garde.",
    tint: "from-emerald-500/40",
  },
  {
    img: pTrust,
    title: "Absolute Trust",
    desc: "A decades-long reputation for reliability and excellence. Our word is our bond, and our execution is our signature.",
    tint: "from-gold/40",
  },
];
      ...
      <div ref={containerRef}>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative" data-reveal>
              ...
              <div className="absolute -bottom-6 -right-6 md:-right-12 bg-gold text-navy p-6 md:p-10 shadow-2xl z-20 max-w-[280px] md:max-w-sm">
                ...
                <div className="mt-2 text-[10px] uppercase tracking-[0.3em] font-bold opacity-60 italic">
                  — The RS Signature
                </div>
              </div>
            </div>
            <div data-reveal>
              ...
              <p className="mt-8 text-xl text-text-muted leading-relaxed font-light">
                With over 15 years in the hospitality and luxury sector, Sanjeev founded RS Group
                with a singular mission: to bring world-class event production to Delhi NCR.
              </p>
              <p className="mt-6 text-text-muted leading-relaxed">
                His eye for detail and uncompromising standard for excellence have made RS Group a
                name synonymous with prestige. Sanjeev personally oversees the creative direction of
                every major project, ensuring the RS signature is present in every floral
                arrangement and lighting cue.
              </p>
          ...
          <div className="container-luxe">
            <div className="grid md:grid-cols-2 gap-20 items-center">
              <div className="max-w-2xl">
                <div className="gold-divider !justify-start mb-10">
                  <span className="eyebrow text-gold/80">Our Network</span>
                </div>
                ...
                <p className="text-white/80 text-xl leading-relaxed font-light">
                  RS Group isn't just a team; it's a curated hub of the region's most talented
                  florists, set designers, and lighting technicians.
                </p>
                ...
                <div className="mt-16 grid grid-cols-2 gap-px bg-white/10 border border-white/10">
                  {collectiveStats.map((item, idx) => (
                    <div
                      key={idx}
                      className="bg-bg-main p-8 hover:bg-white/5 transition-colors group"
                    >
                      <div className="text-gold font-display text-3xl mb-2 group-hover:scale-110 transition-transform origin-left">
                        {item.count}
                      </div>
                      <div className="text-white text-sm uppercase tracking-widest mb-1">
                        {item.role}
                      </div>
        ...
        <section className="bg-bg-main relative">
          {philosophies.map((p, i) => (
            <div
              key={i}
              className="relative min-h-[600px] md:min-h-[80vh] flex items-center overflow-hidden group border-b border-white/5"
            >
              <div className="absolute inset-0">
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${p.tint} via-bg-main/90 to-bg-main`}
                />
              </div>
            ...
            <div className="absolute bottom-12 left-12 right-12 flex flex-col md:flex-row justify-between items-end md:items-center gap-6">
              <div className="max-w-xl">
                <h3 className="font-display text-4xl text-white mb-4 italic">
                  Bespoke Talent Procurement
                </h3>
                <p className="text-white/80 leading-relaxed">
                  Every project at RS Group is unique. We don't believe in a one-size-fits-all team.
                  Instead, we assemble a bespoke collective of artisans specifically chosen for the
                  architectural and emotional requirements of your event.
                </p>
              </div>
        ...
        <section className="bg-bg-accent py-20 border-t border-white/5 overflow-hidden relative">
          <div className="container-luxe text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
              <span className="font-display text-2xl md:text-3xl tracking-tight text-white/60">
                Delhi NCR Planners
              </span>
              <span className="font-display text-2xl md:text-3xl tracking-tight text-white/60">
                Surajkund Elite
