  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About RS Group Events" },
      {
        ...
        content: "Our story, our mission and the team behind unforgettable celebrations.",
      },
...
const values = [
  {
    img: vElegance,
    title: "Elegance",
    desc: "A refined aesthetic in every choice we make.",
    color: "from-purple-500/20",
  },
  {
    img: vReliability,
    title: "Reliability",
    desc: "We deliver on every promise — without exception.",
    color: "from-blue-500/20",
  },
  {
    img: vCustomization,
    title: "Customization",
    desc: "No two events alike. Each one designed for you.",
    color: "from-gold/20",
  },
  {
    img: vGuest,
    title: "Guest Experience",
    desc: "We design for the people who walk through the door.",
...
const steps = [
  {
    n: "01",
    t: "The Consultation",
    d: "A deep dive into your dreams, preferences and must-haves.",
    img: aConsultation,
  },
  {
    n: "02",
    t: "The Design Phase",
    d: "Bringing concepts to life with mood boards and 3D renders.",
    img: aDesign,
  },
  {
    n: "03",
    t: "The Execution",
    d: "On-site management that ensures a flawless guest experience.",
    img: aExecution,
  },
];
...
const palette = [
  {
    name: "Royal Gold",
    feeling: "Prestige & Warmth",
    color: "bg-[#D4AF37]",
    img: vElegance,
    desc: "The foundation of luxury, evoking a sense of timeless celebration and architectural grandeur.",
  },
  {
    name: "Deep Amethyst",
    feeling: "Mystery & Depth",
    color: "bg-[#663399]",
    img: vReliability,
    desc: "A soulful choice for evening galas, where shadows and light dance in perfect cinematic harmony.",
  },
  {
    name: "Crimson Love",
    feeling: "Passion & Energy",
    color: "bg-[#DC143C]",
    img: vGuest,
    desc: "The heartbeat of a celebration, bringing a vibrant, pulse-pounding energy to every corner.",
  },
];
    ...
    <Layout>
      <div ref={containerRef}>
        <PageHero
          ...
          title={
            <span className="about-main-title !text-white !opacity-100 drop-shadow-2xl">
              The studio behind every{" "}
              <span className="italic !text-gold !opacity-100">unforgettable</span> moment.
            </span>
          }
          subtitle={
        ...
        <section className="container-luxe py-24 md:py-40 grid md:grid-cols-2 gap-16 items-center relative overflow-hidden">
          ...
          <div className="space-y-8 relative z-10">
            ...
            <h2 className="font-display text-5xl md:text-7xl text-white leading-tight">
              A passion that became a craft.
            </h2>
            <div className="space-y-6 text-white/80 text-lg font-light leading-relaxed">
              <p>
                RS Group Events began with a single, simple belief: every celebration deserves to be
                remembered. What started as a small wedding studio in Surajkund has grown into a
                trusted partner for hundreds of couples, families and brands across Delhi NCR.
              </p>
              <p>
                Today, our team brings together planners, stylists, florists and coordinators — all
                united by a love for the moments that matter. We don't just plan events; we
                architect memories that defy the ordinary.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-bg-accent py-32 md:py-56 border-t border-white/5 relative overflow-hidden">
              ...
              <div className="lg:col-span-7 grid md:grid-cols-2 gap-8">
                <div className="bg-bg-card p-10 text-white rounded-tr-[4rem] group hover:bg-white/5 transition-all">
                  ...
                  <p className="text-white/60 font-light leading-relaxed">
                    We apply architectural rigor to logistics, ensuring every second of your event
                    is accounted for.
                  </p>
                </div>
                <div className="bg-bg-card p-10 border border-white/10 group hover:border-gold transition-all">
                  ...
                  <p className="text-white/60 font-light leading-relaxed">
                    Design is a feeling. We manipulate textures and colors to evoke specific
                    emotional responses.
                  </p>
                </div>
              </div>
          ...
          <div className="decorative-text -bottom-10 -right-20 opacity-[0.02] -rotate-12">
            STUDIO
          </div>
        </section>
        ...
        <section className="relative py-24 md:py-40 overflow-hidden">
          ...
          <div className="container-luxe relative grid md:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-12 border-l-4 border-gold group hover:bg-white/10 transition-all duration-500">
              ...
              <p className="font-display text-3xl md:text-4xl text-white leading-tight group-hover:translate-x-2 transition-transform">
                To be Delhi NCR's most loved luxury event studio — known for elegance, integrity and
                care.
              </p>
            </div>
          </div>
          ...
          <div className="values-grid mt-24 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((v) => (
              ...
              >
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-t ${v.color} via-bg-main/90 to-transparent`}
                />
              ...
              {steps.map((s, idx) => (
                ...
                >
                  ...
                  <div className="flex-1 max-w-xl text-center md:text-left">
                    ...
                    <h3 className="font-display text-4xl md:text-6xl text-white mb-8 leading-[1.1]">
                      {s.t}
                    </h3>
          ...
          <div className="container-luxe relative z-10">
            ...
            <div className="mt-20 grid lg:grid-cols-3 gap-1px bg-white/5 border border-white/5 rounded-[3rem] overflow-hidden shadow-2xl">
              {palette.map((item) => (
                <div
                  key={item.name}
                  className="group relative bg-bg-main p-12 lg:p-16 min-h-[500px] flex flex-col justify-between overflow-hidden transition-all duration-700"
                >
                  <div
                    className={`absolute top-0 right-0 w-32 h-32 ${item.color} opacity-20 blur-[60px] group-hover:opacity-40 transition-opacity`}
                  />

                  <div className="relative z-10">
                    <div className={`w-4 h-24 ${item.color} mb-8 rounded-full`} />
                    <h3 className="font-display text-4xl text-white mb-2">{item.name}</h3>
                    <div className="text-gold eyebrow text-xs tracking-[0.3em] uppercase">
                      {item.feeling}
                    </div>
                  </div>
        ...
        <section className="relative overflow-hidden bg-bg-main border-t border-white/5">
          ...
          <div className="decorative-text bottom-0 left-0 opacity-[0.02] -translate-x-1/4 translate-y-1/4 rotate-12">
            JOURNEY
          </div>
        </section>
      </div>
