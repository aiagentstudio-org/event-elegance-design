    ...
    <Layout>
      <div ref={containerRef}>
        ...
        <section className="relative overflow-hidden py-24 md:py-40" data-animate>
          ...
          <div className="container-luxe grid lg:grid-cols-2 gap-16 md:gap-24 items-center relative z-10">
            <div>
              ...
              <h2 className="font-display text-5xl md:text-7xl text-text-main leading-[1.05]">The Prestige of <br/><span className="italic text-gold">Surajkund.</span></h2>
              ...
              <div className="mt-12 grid grid-cols-2 gap-y-10 gap-x-8">
                {[
                  ...
                  <div key={item.label} className="group glass-card p-6 border-none bg-white/5 hover:bg-white/10 transition-colors">
                    ...
                    <div className="text-[10px] uppercase tracking-[0.2em] text-text-muted font-bold">{item.label}</div>
            ...
            {[g1, g2, g4].map((src, i) => (
              <div key={i} className={`group relative glass-card p-1.5 overflow-hidden transition-all duration-700 hover:shadow-gold/20 ${i === 0 ? 'md:row-span-2' : ''}`}>
                <div className="h-full w-full overflow-hidden rounded-sm">
                  <img src={src} alt={`RS Group Events luxury celebration ${i + 1}`} className="h-full w-full object-cover transition-transform duration-1000 group-hover:scale-110" />
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="bg-bg-main py-24 md:py-48 relative overflow-hidden" data-animate>
          ...
          <div className="decorative-text -bottom-20 left-1/2 -translate-x-1/2 opacity-[0.02]">RS GROUP</div>
          ...
          <div className="container-luxe text-center relative z-10">
            ...
            <h2 className="font-display text-6xl md:text-9xl text-white mb-20 leading-tight">Spanning the <span className="italic text-gold">Capital.</span></h2>
            
            <div className="flex flex-wrap justify-center gap-6 md:gap-8 city-grid max-w-6xl mx-auto">
              {cities.map((c) => (
                <div key={c.name} className="city-tag px-10 py-6 glass-card border-white/10 hover:border-gold/50 bg-white/[0.03] hover:bg-gold/10 transition-all duration-700 cursor-default group backdrop-blur-md">
                  <div className="text-[10px] text-gold font-bold mb-3 tracking-[0.4em] group-hover:tracking-[0.6em] transition-all duration-700">{c.code}</div>
                  <div className="text-white font-display text-2xl group-hover:text-gold transition-colors duration-700">{c.name}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="bg-navy-deep relative overflow-hidden border-t border-white/5" data-animate>
          <div className="container-luxe py-32 md:py-56 relative z-10">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="space-y-12 text-left">
                <div className="gold-divider !justify-start"><span className="eyebrow">Studio Experience</span></div>
                <h2 className="font-display text-6xl md:text-8xl text-white italic leading-[1.1]">Visit the <span className="text-gold">studio.</span></h2>
                <p className="text-ivory/60 text-xl font-light leading-relaxed max-w-xl">
                  Architecture, moodboards, and venue portfolios come alive in our Surajkund creative hub. Experience our process before you book your date.
                </p>
                <div className="pt-6">
                  <CtaButton to="/contact" variant="gold" className="px-16 py-7 scale-110 shadow-[0_0_50px_rgba(212,175,55,0.15)]">
                    Request Site Visit
                  </CtaButton>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative aspect-[4/3] overflow-hidden rounded-xl border border-white/10 shadow-2xl">
                  <img src={g4} className="w-full h-full object-cover grayscale group-hover:grayscale-0 scale-110 group-hover:scale-100 transition-all duration-1000" alt="Studio tour" />
