  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Our Work — Every Event, a Masterpiece" },
      {
        ...
        content: "A gallery of weddings, corporate events and celebrations.",
      },
      ...
      <div ref={containerRef}>
        ...
        <section className="container-luxe pt-16 pb-8">
          <p className="text-text-muted text-lg leading-relaxed max-w-3xl mx-auto text-center font-light">
            Explore our portfolio of luxury weddings, corporate galas, bespoke floral installations,
            and private celebrations across Delhi NCR. Each event is designed with architectural
            precision and creative artistry by the RS Group Events team.
          </p>
        </section>
        ...
        <section className="relative">
                ...
                {tabs.map((t) => (
                  <button
                    ...
                    className={`relative px-10 py-4 text-[11px] uppercase tracking-[0.4em] font-bold transition-all duration-700 ${
                      active === t ? "text-gold scale-110" : "text-text-muted/60 hover:text-gold"
                    }`}
                  >
                    {t}
                    {active === t && (
          ...
          <div className="container-luxe py-24 md:py-40 min-h-[60vh] relative">
            <div className="decorative-text top-40 right-10 opacity-[0.03] rotate-90 origin-right pointer-events-none select-none">
              PORTFOLIO
            </div>
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-navy-deep/40 opacity-0 group-hover:opacity-100 transition-all duration-700 flex flex-col justify-end p-10 backdrop-blur-[2px]">
                      <div className="translate-y-8 group-hover:translate-y-0 transition-transform duration-700">
                        <div className="eyebrow text-gold mb-3 text-xs tracking-[0.3em]">
                          {it.cat}
                        </div>
                        <div className="font-display text-ivory text-3xl md:text-4xl tracking-tight leading-none">
                          {it.label}
                        </div>
                      </div>
                    </div>
        ...
        <section
          className="bg-navy-deep text-ivory py-40 md:py-60 relative overflow-hidden"
          data-animate
        >
          ...
          <div className="container-luxe text-center relative">
            ...
            <div className="mt-24">
              <CtaButton
                href="https://www.instagram.com/rsgroupdecors?igsh=dTFwYjVkbzJycnNi&utm_source=rsgroupevent.com"
                variant="outline"
                className="px-16 py-6 border-gold/30 hover:border-gold scale-125"
              >
                Follow the Story
              </CtaButton>
            </div>
        ...
        <section
          className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-navy-deep"
          data-animate
        >
          {/* Background Elements */}
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center opacity-[0.03] select-none pointer-events-none z-0">
            <div className="font-display text-[25vw] leading-none tracking-tighter italic">
              RS GROUP
            </div>
          </div>
          ...
          <div className="container-luxe relative z-10 text-center">
            <div className="gold-divider mx-auto mb-10">
              <span className="eyebrow !text-gold/60">The Next Masterpiece</span>
            </div>
            ...
            <p className="text-ivory/50 text-xl md:text-2xl font-light mb-16 max-w-2xl mx-auto leading-relaxed">
              Every legacy begins with a single conversation. Our creative team is ready to bring
              your vision to life with architectural precision.
            </p>
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              <CtaButton
                to="/contact"
                variant="gold"
                className="px-20 py-7 text-lg scale-110 shadow-[0_0_50px_rgba(212,175,55,0.2)]"
              >
                Start Planning
              </CtaButton>
              <CtaButton
                ...
                variant="outline"
                className="px-16 py-7 text-lg border-white/20 text-white hover:border-gold"
              >
                Quick Call
              </CtaButton>
            </div>
          ...
          <div className="absolute bottom-10 right-10 flex items-center gap-4 opacity-20">
            ...
            <span className="text-[10px] uppercase tracking-[0.5em] text-gold font-bold italic">
              Est. 2012
            </span>
          </div>
        </section>
