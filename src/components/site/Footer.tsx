      ...
      <div className="container-luxe py-16 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-4 text-sm leading-relaxed text-text-muted">
            Luxury wedding & corporate event planners crafting unforgettable celebrations across
            Delhi NCR.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/venue-events" className="hover:text-gold">
                Venue & Events
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex gap-2">
              <Phone size={16} className="text-gold mt-0.5" /> +91 99535 95353
            </li>
            <li className="flex gap-2">
              <Mail size={16} className="text-gold mt-0.5" /> sanjeev@rsgroupevent.com
            </li>
            <li className="flex gap-2">
              <Mail size={16} className="text-gold mt-0.5" /> hello@rsgroupevent.com
            </li>
            <li className="flex gap-2">
              <MapPin size={16} className="text-gold mt-0.5" /> Surajkund, Faridabad, Delhi NCR
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-3">
            <a
              ...
              className="p-2.5 border border-gold/40 hover:bg-gold hover:text-navy transition-colors rounded-sm"
            >
              <Instagram size={18} />
            </a>
            <a
          ...
          <p className="text-xs text-ivory/60 mt-6">
            Service area: Surajkund · Faridabad · Delhi · Gurgaon · Noida
          </p>
        </div>
      </div>
